...
import { useDeleteVehicle } from '@/hooks/api/use-vehicle-mutations';
...
export const VehicleCellAction: React.FC<CellActionProps> = ({ data }) => {
        ...
        deleteVehicle(data.id, {
            ...
            onError: (err: any) => {
                const msg =
                    ...
                    err?.message ||
                    'Gagal menghapus kendaraan. Silakan coba lagi.';
                setErrorMsg(msg);
            },
        });
    };
            ...
            <DropdownMenu modal={false}>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem
                        onClick={(e) => {
                            e.stopPropagation();
                            router.push(`/dashboard/vehicles/${data.id}/edit`);
                        }}
                    >
