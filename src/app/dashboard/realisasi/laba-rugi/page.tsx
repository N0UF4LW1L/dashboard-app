                    ...
                    <table className="w-full border-collapse min-w-[600px]">
                      <thead>
                        <tr className="border-b border-gray-200 bg-gray-50">
                          <th className="text-left py-3 px-4 font-medium text-gray-700 border-r border-gray-300 text-xs sm:text-sm" rowSpan={2}>
                            No Akun
                          </th>
                          <th className="text-left py-3 px-4 font-medium text-gray-700 border-r border-gray-300 text-xs sm:text-sm" rowSpan={2}>
                            Nama Akun
                          </th>
                          <th className="text-center py-3 px-4 font-medium text-gray-700 border-r border-gray-300 text-xs sm:text-sm" colSpan={2}>
                            Realisasi
                          </th>
                        </tr>
                        <tr className="border-b border-gray-200 bg-gray-50">
                          <th className="text-right py-2 px-4 font-medium text-gray-600 border-r border-gray-300 text-xs sm:text-sm">
                            RP
                          </th>
                          <th className="text-right py-2 px-4 font-medium text-gray-600 text-xs sm:text-sm">
                            RP
                          </th>
                        </tr>
                      </thead>
                      ...
                      {isLoading ? (
                        ...
                        <>
                          ...
                          <tr className="bg-gray-100 border-t-2 border-gray-400 border-b">
                            ...
                            <td className="py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-bold text-gray-900 text-right whitespace-nowrap">
