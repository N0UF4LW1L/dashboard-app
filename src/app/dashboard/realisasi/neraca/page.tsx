                    ...
                    {isLoading ? (
                      ...
                      <>
                        ...
                        <tr className="bg-gray-100 border-b border-gray-200">
                          <td className="py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-semibold text-gray-900" colSpan={4}>
                            AKTIVA
                          </td>
                        </tr>
                        ...
                        <tr className="bg-gray-100 border-b border-gray-200">
                          <td className="py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-medium text-gray-800" colSpan={4}>
                            AKTIVA LANCAR
                          </td>
                        </tr>
                        ...
                        {filteredCurrentAssets.length > 0 ? (
                          filteredCurrentAssets.map((item: any, index: number) => (
                            <tr key={`current-asset-${index}`} className="bg-white hover:bg-gray-50 border-b border-gray-200">
                              ...
                              <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-700 text-right border-r border-gray-300 whitespace-nowrap">
                                {item.running_balance > 0 ? formatRupiah(item.running_balance) : '-'}
                              </td>
                              <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-700 text-right whitespace-nowrap">
                          ...
                          <tr className="bg-white border-b border-gray-200">
                            <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500 italic" colSpan={4}>
                        ...
                        <tr className="bg-gray-100 border-t-2 border-gray-400 border-b border-gray-200">
                          ...
                          <td className="py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-semibold text-gray-900 text-right border-r border-gray-300 whitespace-nowrap">
                        ...
                        <tr className="bg-blue-50 border-t-2 border-blue-400">
                          <td className="py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-bold text-blue-900 border-r border-blue-300" colSpan={2}>
                            TOTAL PASIVA
                          </td>
                          <td className="py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-bold text-blue-900 text-right border-r border-blue-300 whitespace-nowrap">
                            -
                          </td>
                          <td className="py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-bold text-blue-900 text-right whitespace-nowrap">
