...
export default function JurnalUmumPage() {
  ...
  return (
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      {/* Period Information */}
      <div className="text-xs sm:text-sm text-muted-foreground mb-4 flex flex-col sm:flex-row gap-1 sm:gap-0">
        <span>
          Periode: {dayjs(dateRange.from).format('DD MMM YYYY')} - {dayjs(dateRange.to).format('DD MMM YYYY')}
        </span>
        {debouncedSearchQuery && (
          <span className="sm:ml-2 text-blue-600">
          ...
          {isLoading ? (
            ...
            <div>
              ...
              <div className="mt-4 border-t pt-4">
                <div className="flex flex-col sm:flex-row justify-end items-start sm:items-center gap-3 sm:gap-12">
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-0 w-full sm:w-auto">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-1 sm:gap-2">
                      <span className="text-sm sm:text-base font-medium text-gray-700">Debit:</span>
                      <span className="text-xs sm:text-base font-mono font-semibold text-gray-900 break-all sm:break-normal">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-0 w-full sm:w-auto">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-1 sm:gap-2">
                      <span className="text-sm sm:text-base font-medium text-gray-700">Credit:</span>
                      <span className="text-xs sm:text-base font-mono font-semibold text-gray-900 break-all sm:break-normal">
