                    ...
                    {isLoading ? (
                      ...
                      <>
                        ...
                        <tr className="bg-gray-100 border-b border-gray-200">
                          <td className="py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-semibold text-gray-900" colSpan={5}>
                        ...
                        {filteredOperatingActivities.length > 0 ? (
                          ...
                          <tr className="bg-white border-b border-gray-200">
                            <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500 italic" colSpan={5}>
