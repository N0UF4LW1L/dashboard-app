...
export default function RoleSelectionPage() {
    ...
    return (
        <div className="bg-gradient-to-br from-blue-50 via-white to-blue-50 min-h-screen py-8 px-4 relative">
            ...
            <div className="w-full max-w-4xl mx-auto relative z-10 flex flex-col items-center justify-center min-h-screen py-8">
                {/* Logo */}
                <div className="mb-2 text-center" style={{ animation: 'fade-in 0.8s ease-out' }}>
                    <Image
                        src="/logo.png"
                        alt="TransGo Logo"
                        width={220}
                ...
                {/* Welcome Text */}
                <div className="text-center mb-6" style={{ animation: 'fade-in-delay 0.8s ease-out 0.3s both' }}>
                ...
                {/* Copyright */}
                <div className="text-center mt-8 pt-6 border-t border-gray-200 w-full">
